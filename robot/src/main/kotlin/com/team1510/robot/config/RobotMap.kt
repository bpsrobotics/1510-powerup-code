...
const val RIGHT_MASTER_CANID: Int = 4
const val LEFT_SLAVE_CANID: Int = 2
const val RIGHT_SLAVE_CANID: Int = 5

//Bunnybot: 8 3 4 5
//1510: 1,4,2,5
//Ramp:
const val RIGHT_RAMP_SOL_FWD_ID: Int = 2
const val RIGHT_RAMP_SOL_REV_ID: Int = 3
...
const val RIGHT_INTAKE_PWM_ID: Int = 8
const val LEFT_INTAKE_PWM_ID: Int = 7

//Arm
const val LEFT_ARM_MOTOR_CANID: Int = 6
const val RIGHT_ARM_MOTOR_CANID: Int = 3